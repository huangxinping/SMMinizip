...
local unzFile unzOpenInternal(const void *path, zlib_filefunc64_32_def* pzlib_filefunc64_32_def, int is64bitOpenFunction)
{
    ...
    if (pzlib_filefunc64_32_def == NULL)
        sm_fill_fopen64_filefunc(&us.z_filefunc.zfile_func64);
    else
    ...
    {
        *s = us;
        sm_unzGoToFirstFile((unzFile)s);
    }
    return (unzFile)s;
}

extern unzFile ZEXPORT sm_unzOpen2(const char *path, zlib_filefunc_def* pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
        zlib_filefunc64_32_def zlib_filefunc64_32_def_fill;
        sm_fill_zlib_filefunc64_32_def_from_filefunc32(&zlib_filefunc64_32_def_fill, pzlib_filefunc32_def);
        return unzOpenInternal(path, &zlib_filefunc64_32_def_fill, 0);
    }
    return unzOpenInternal(path, NULL, 0);
}

extern unzFile ZEXPORT sm_sm_unzOpen2_64(const void *path, zlib_filefunc64_def* pzlib_filefunc_def)
{
...
extern unzFile ZEXPORT sm_unzOpen(const char *path)
{
    return unzOpenInternal(path, NULL, 0);
}

extern unzFile ZEXPORT sm_unzOpen64(const void *path)
{
    return unzOpenInternal(path, NULL, 1);
}

extern int ZEXPORT sm_unzClose(unzFile file)
{
    unz64_s* s;
    if (file == NULL)
...
extern int ZEXPORT sm_unzGetGlobalInfo(unzFile file, unz_global_info* pglobal_info32)
{
    unz64_s* s;
    if (file == NULL)
        return UNZ_PARAMERROR;
...
extern int ZEXPORT sm_unzGetGlobalInfo64(unzFile file, unz_global_info64* pglobal_info)
{
    unz64_s* s;
    if (file == NULL)
        return UNZ_PARAMERROR;
...
extern int ZEXPORT sm_unzGetGlobalComment(unzFile file, char *comment, uLong comment_size)
{
    unz64_s* s;
...
extern int ZEXPORT sm_unzGetCurrentFileInfo(unzFile file, unz_file_info * pfile_info, char *filename, 
...
extern int ZEXPORT sm_unzGetCurrentFileInfo64(unzFile file, unz_file_info64 * pfile_info, char *filename, 
    uLong filename_size, void *extrafield, uLong extrafield_size, char* comment,  uLong comment_size)
{
...
*/
extern int ZEXPORT sm_unzOpenCurrentFile3(unzFile file, int* method, int* level, int raw, const char* password)
{
    int err = UNZ_OK;
...
extern int ZEXPORT sm_unzOpenCurrentFile(unzFile file)
{
    return sm_unzOpenCurrentFile3(file, NULL, NULL, 0, NULL);
}

extern int ZEXPORT sm_unzOpenCurrentFilePassword(unzFile file, const char* password)
{
    return sm_unzOpenCurrentFile3(file, NULL, NULL, 0, password);
}

extern int ZEXPORT sm_unzOpenCurrentFile2(unzFile file, int* method, int* level, int raw)
{
    return sm_unzOpenCurrentFile3(file, method, level, raw, NULL);
}
...
extern int ZEXPORT sm_unzReadCurrentFile(unzFile file, voidp buf, unsigned len)
{
    int err = UNZ_OK;
    uInt read = 0;
    unz64_s* s;
...
extern ZPOS64_T ZEXPORT sm_unzGetCurrentFileZStreamPos64( unzFile file)
{
    unz64_s* s;
    file_in_zip64_read_info_s* pfile_in_zip_read_info;
    s = (unz64_s*)file;
...
extern int ZEXPORT sm_unzGetLocalExtrafield(unzFile file, voidp buf, unsigned len)
{
    unz64_s* s;
    file_in_zip64_read_info_s* pfile_in_zip_read_info;
    uInt read_now;
...
extern int ZEXPORT sm_unzCloseCurrentFile(unzFile file)
{
    int err = UNZ_OK;
...
extern int ZEXPORT sm_unzGoToFirstFile2(unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size)
{
    int err = UNZ_OK;
    unz64_s* s;
...
extern int ZEXPORT sm_unzGoToFirstFile(unzFile file)
{
    return sm_unzGoToFirstFile2(file, NULL, NULL, 0, NULL, 0, NULL, 0);
}
...
extern int ZEXPORT sm_unzGoToNextFile(unzFile file)
{
    return unzGoToNextFile2(file, NULL, NULL, 0, NULL, 0, NULL, 0);
}

extern int ZEXPORT sm_unzLocateFile(unzFile file, const char *filename, unzFileNameComparer filename_compare_func)
{
    unz64_s* s;
    int err;
    ...
    err = sm_unzGoToFirstFile2(file, NULL, current_filename, sizeof(current_filename)-1, NULL, 0, NULL, 0);
...
extern int ZEXPORT sm_unzGetFilePos(unzFile file, unz_file_pos* file_pos)
{
    unz64_file_pos file_pos64;
    int err = sm_unzGetFilePos64(file,&file_pos64);
    if (err == UNZ_OK)
    {
...
extern int ZEXPORT sm_unzGoToFilePos(unzFile file, unz_file_pos* file_pos)
{
    unz64_file_pos file_pos64;
    ...
    return sm_unzGoToFilePos64(file,&file_pos64);
}

extern int ZEXPORT sm_unzGetFilePos64(unzFile file, unz64_file_pos*  file_pos)
{
    unz64_s* s;
...
extern int ZEXPORT sm_unzGoToFilePos64(unzFile file, const unz64_file_pos* file_pos)
{
    unz64_s* s;
    int err;
...
extern ZPOS64_T ZEXPORT sm_unzGetOffset64(unzFile file)
{
    unz64_s* s;
...
extern uLong ZEXPORT sm_unzGetOffset(unzFile file)
{
    ZPOS64_T offset64;

    if (file == NULL)
        return 0; //UNZ_PARAMERROR;
    offset64 = sm_unzGetOffset64(file);
    return (uLong)offset64;
}

extern int ZEXPORT sm_unzSetOffset(unzFile file, uLong pos)
{
    return sm_unzSetOffset64(file, pos);
}

extern int ZEXPORT sm_unzSetOffset64(unzFile file, ZPOS64_T pos)
{
    unz64_s* s;
    int err;
...
extern z_off_t ZEXPORT sm_unztell(unzFile file)
{
    unz64_s* s;
    file_in_zip64_read_info_s* pfile_in_zip_read_info;
    if (file == NULL)
...
extern ZPOS64_T ZEXPORT sm_unztell64(unzFile file)
{
...
extern int ZEXPORT sm_unzeof(unzFile file)
{
    unz64_s* s;
    file_in_zip64_read_info_s* pfile_in_zip_read_info;
    if (file == NULL)
