...
extern unzFile ZEXPORT sm_unzOpen OF((const char *path));

extern unzFile ZEXPORT sm_unzOpen64 OF((const void *path));
/* Open a Zip file.
   ...
   open64_file_func callback. Under Windows, if UNICODE is defined, using sm_fill_fopen64_filefunc, the path 
   is a pointer to a wide unicode string  (LPCTSTR is LPCWSTR), so const char* does not describe the reality */

extern unzFile ZEXPORT sm_unzOpen2 OF((const char *path, zlib_filefunc_def* pzlib_filefunc_def));
/* Open a Zip file, like unzOpen, but provide a set of file low level API for read/write operations */
extern unzFile ZEXPORT sm_sm_unzOpen2_64 OF((const void *path, zlib_filefunc64_def* pzlib_filefunc_def));
/* Open a Zip file, like unz64Open, but provide a set of file low level API for read/write 64-bit operations */

extern int ZEXPORT sm_unzClose OF((unzFile file));
...
extern int ZEXPORT sm_unzOpenCurrentFile OF((unzFile file));
/* Open for reading data the current file in the zipfile.

   return UNZ_OK if no error */

extern int ZEXPORT sm_unzOpenCurrentFilePassword OF((unzFile file, const char* password));
/* Open for reading data the current file in the zipfile.
...
extern int ZEXPORT sm_unzReadCurrentFile OF((unzFile file, voidp buf, unsigned len));
...
extern int ZEXPORT sm_unzGetCurrentFileInfo OF((unzFile file, unz_file_info *pfile_info, char *filename,
...
extern int ZEXPORT sm_unzCloseCurrentFile OF((unzFile file));
...
extern int ZEXPORT sm_unzGoToFirstFile OF((unzFile file));
/* Set the current file of the zipfile to the first file.

   return UNZ_OK if no error */

extern int ZEXPORT sm_unzGoToFirstFile2 OF((unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
/* Set the current file of the zipfile to the first file and retrieves the current info on success. 
   Not as seek intensive as sm_unzGoToFirstFile + unzGetCurrentFileInfo.

   return UNZ_OK if no error */

extern int ZEXPORT sm_unzGoToNextFile OF((unzFile file));
/* Set the current file of the zipfile to the next file.

   return UNZ_OK if no error
   return UNZ_END_OF_LIST_OF_FILE if the actual file was the latest */

extern int ZEXPORT sm_unzGoToNextFile2 OF((unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
...
extern int ZEXPORT sm_unzGetFilePos64 OF((unzFile file, unz64_file_pos* file_pos));
extern int ZEXPORT sm_unzGoToFilePos64 OF((unzFile file, const unz64_file_pos* file_pos));
...
extern int ZEXPORT sm_unzSetOffset64 OF((unzFile file, ZPOS64_T pos));
