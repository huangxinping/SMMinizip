...
extern zipFile ZEXPORT sm_zipOpen OF((const char *pathname, int append));
/* Create a zipfile.
...
extern int ZEXPORT sm_zipOpenNewFileInZip OF((zipFile file, const char* filename, const zip_fileinfo* zipfi,
...
extern int ZEXPORT sm_zipOpenNewFileInZip3 OF((zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void* extrafield_global, 
...
extern int ZEXPORT sm_zipWriteInFileInZip OF((zipFile file, const void* buf, unsigned len));
/* Write data in the zipfile */

extern int ZEXPORT sm_zipCloseFileInZip OF((zipFile file));
/* Close the current file in the zipfile */

extern int ZEXPORT sm_zipCloseFileInZipRaw OF((zipFile file, uLong uncompressed_size, uLong crc32));
extern int ZEXPORT sm_zipCloseFileInZipRaw64 OF((zipFile file, ZPOS64_T uncompressed_size, uLong crc32));
/* Close the current file in the zipfile, for file opened with parameter raw=1 in zipOpenNewFileInZip2
   uncompressed_size and crc32 are value for the uncompressed size */

extern int ZEXPORT sm_zipClose OF((zipFile file, const char* global_comment));
/* Close the zipfile */
