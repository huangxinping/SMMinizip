...
voidpf sm_call_zopen64 (const zlib_filefunc64_32_def* pfilefunc,const void*filename,int mode)
{
...
long sm_call_zseek64 (const zlib_filefunc64_32_def* pfilefunc,voidpf filestream, ZPOS64_T offset, int origin)
{
...
ZPOS64_T sm_call_ztell64 (const zlib_filefunc64_32_def* pfilefunc,voidpf filestream)
{
    uLong tell_uLong;
    if (pfilefunc->zfile_func64.zseek64_file != NULL)
...
void sm_fill_zlib_filefunc64_32_def_from_filefunc32(zlib_filefunc64_32_def* p_filefunc64_32,const zlib_filefunc_def* p_filefunc32)
{
...
void sm_fill_fopen_filefunc (pzlib_filefunc_def)
...
void sm_fill_fopen64_filefunc (zlib_filefunc64_def*  pzlib_filefunc_def)
{
