...
const char sm_zip_copyright[] =" zip 1.01 Copyright 1998-2004 Gilles Vollant - http://www.winimage.com/zLibDll";
    ...
    zlib_filefunc64_32_def* pzlib_filefunc64_32_def)
{
    ...
    if (pzlib_filefunc64_32_def == NULL)
        sm_fill_fopen64_filefunc(&ziinit.z_filefunc.zfile_func64);
    else
...
extern zipFile ZEXPORT sm_zipOpen2(const char *pathname, int append, zipcharpc* globalcomment, 
...
extern zipFile ZEXPORT sm_zipOpen2_64(const void *pathname, int append, zipcharpc* globalcomment, 
...
extern zipFile ZEXPORT sm_zipOpen3(const char *pathname, int append, ZPOS64_T disk_size, zipcharpc* globalcomment, 
    zlib_filefunc_def* pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
...
extern zipFile ZEXPORT sm_zipOpen(const char* pathname, int append)
{
    return sm_zipOpen3((const void*)pathname,append,0,NULL,NULL);
}

extern zipFile ZEXPORT sm_zipOpen64(const void* pathname, int append)
{
    return sm_zipOpen3(pathname,append,0,NULL,NULL);
}

extern int ZEXPORT sm_zipOpenNewFileInZip4_64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
...
extern int ZEXPORT sm_zipOpenNewFileInZip4(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void* extrafield_global, 
...
extern int ZEXPORT sm_zipOpenNewFileInZip3(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void* extrafield_global, 
    uInt size_extrafield_global, const char* comment, int method, int level, int raw, int windowBits, 
...
extern int ZEXPORT sm_zipOpenNewFileInZip3_64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void* extrafield_global, 
    uInt size_extrafield_global, const char* comment, int method, int level, int raw, int windowBits, 
...
extern int ZEXPORT sm_zipOpenNewFileInZip2(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void* extrafield_global, 
...
extern int ZEXPORT sm_zipOpenNewFileInZip2_64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void* extrafield_global, 
...
extern int ZEXPORT sm_zipOpenNewFileInZip64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void*extrafield_global, 
...
extern int ZEXPORT sm_zipOpenNewFileInZip(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    const void* extrafield_local, uInt size_extrafield_local, const void*extrafield_global, 
...
extern int ZEXPORT sm_zipWriteInFileInZip(zipFile file,const void* buf,unsigned int len)
{
    zip64_internal* zi;
    int err = ZIP_OK;
...
extern int ZEXPORT sm_zipCloseFileInZipRaw(zipFile file, uLong uncompressed_size, uLong crc32)
{
    return sm_zipCloseFileInZipRaw64 (file, uncompressed_size, crc32);
}

extern int ZEXPORT sm_zipCloseFileInZipRaw64(zipFile file, ZPOS64_T uncompressed_size, uLong crc32)
{
    zip64_internal* zi;
...
extern int ZEXPORT sm_zipCloseFileInZip(zipFile file)
{
    return sm_zipCloseFileInZipRaw(file, 0, 0);
}

extern int ZEXPORT sm_zipClose(zipFile file, const char* global_comment)
{
    zip64_internal* zi;
    int err = 0;
